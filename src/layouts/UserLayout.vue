<template>
  <q-layout view="lHh Lpr lFf">
    <q-toolbar unelevated style="height: 70px;" class="bg-white text-white text-blue-grey-14">
      <div class="text-h6 q-ml-lg">Movie</div>

      <q-space/>
      <div v-if="$q.screen.md || $q.screen.md || $q.screen.lg || $q.screen.xl">
        <q-btn size="medium" flat>Home</q-btn>
        <q-btn size="medium" flat>Pesanan Saya</q-btn>
